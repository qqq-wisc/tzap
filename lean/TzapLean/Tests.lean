...
def countH (c : RawCircuit) : Nat := countKind isHGate c
...
-- xx_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.x 0, Gate.x 0])).gates.length = 0

-- cnot_cancel
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.cnot 0 1])).gates.length = 0

-- hh_cancel_different_qubit
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 3, Gate.h 3])).gates.length = 0

-- hh_cancel_skips_unrelated_gate
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.t 1, Gate.h 0])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.t 1, Gate.h 0])).gates[0]? = some (Gate.t 1)

-- hh_cancel_blocked_by_same_qubit
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.h 0])).gates.length = 3

-- hh_cancel_multiple_pairs
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0])).gates.length = 0

-- hh_cancel_parallel_qubits
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.h 1, Gate.h 0, Gate.h 1])).gates.length = 0

-- xx_cancel_different_qubit
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.x 2, Gate.x 2])).gates.length = 0

-- xx_cancel_skips_unrelated_gate
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.x 0, Gate.h 1, Gate.x 0])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.x 0, Gate.h 1, Gate.x 0])).gates[0]? = some (Gate.h 1)

-- xx_cancel_blocked_by_same_qubit
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.x 0, Gate.z 0, Gate.x 0])).gates.length = 3

-- xx_cancel_multiple_pairs
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.x 0, Gate.x 0, Gate.x 0, Gate.x 0])).gates.length = 0

-- cnot_cancel_different_qubits
#guard (runCancel (RawCircuit.ofGates 5 0 [Gate.cnot 3 4, Gate.cnot 3 4])).gates.length = 0

-- cnot_cancel_skips_unrelated_gate
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cnot 0 1, Gate.t 2, Gate.cnot 0 1])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cnot 0 1, Gate.t 2, Gate.cnot 0 1])).gates[0]? = some (Gate.t 2)

-- cnot_cancels_through_diagonal_on_control
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.t 0, Gate.cnot 0 1])).gates.length = 1

-- cnots_cancel_through_x_on_target
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.x 1, Gate.cnot 0 1])).gates.length = 1

-- cnots_cancel_through_sharing_control_cnot
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cnot 0 1, Gate.cnot 0 2, Gate.cnot 0 1])).gates.length = 1

-- cnots_cancel_through_sharing_target_cnot
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cnot 0 2, Gate.cnot 1 2, Gate.cnot 0 2])).gates.length = 1

-- cnots_blocked_by_cnot_with_swapped_endpoints
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.cnot 1 0, Gate.cnot 0 1])).gates.length = 3

-- cnots_blocked_by_diagonal_on_target
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.t 1, Gate.cnot 0 1])).gates.length = 3

-- cnots_blocked_by_x_on_control
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.x 0, Gate.cnot 0 1])).gates.length = 3

-- cnot_cancel_blocked_by_hadamard_on_control
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.h 0, Gate.cnot 0 1])).gates.length = 3

-- cnot_cancel_blocked_by_gate_on_target
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.t 1, Gate.cnot 0 1])).gates.length = 3

-- cnot_cancel_no_match_different_direction
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.cnot 1 0])).gates.length = 2

-- cnot_cancel_multiple_pairs
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.cnot 0 1, Gate.cnot 0 1, Gate.cnot 0 1])).gates.length = 0

-- no_match_preserves_circuit
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.t 0, Gate.s 1, Gate.cnot 0 1])).gates.length = 3

-- single_h_preserved
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0])).gates[0]? = some (Gate.h 0)

-- zz_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.z 0, Gate.z 0])).gates.length = 0

-- zz_cancel_skips_unrelated_gate
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.z 0, Gate.t 1, Gate.z 0])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.z 0, Gate.t 1, Gate.z 0])).gates[0]? = some (Gate.t 1)

-- zz_cancel_blocked_by_same_qubit
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.z 0, Gate.h 0, Gate.z 0])).gates.length = 3
...
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.ccx 0 1 2, Gate.t 3, Gate.ccx 0 1 2])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.ccx 0 1 2, Gate.t 3, Gate.ccx 0 1 2])).gates[0]? = some (Gate.t 3)

-- ccx_cancel_blocked_by_control1
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccx 0 1 2, Gate.h 0, Gate.ccx 0 1 2])).gates.length = 3

-- ccx_cancel_blocked_by_control2
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccx 0 1 2, Gate.h 1, Gate.ccx 0 1 2])).gates.length = 3

-- ccx_cancel_blocked_by_target
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccx 0 1 2, Gate.h 2, Gate.ccx 0 1 2])).gates.length = 3

-- ccx_no_cancel_different_controls
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.ccx 0 1 3, Gate.ccx 0 2 3])).gates.length = 2

-- ccx_no_cancel_different_target
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.ccx 0 1 2, Gate.ccx 0 1 3])).gates.length = 2

-- ccx_cancel_multiple_pairs
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccx 0 1 2, Gate.ccx 0 1 2, Gate.ccx 0 1 2, Gate.ccx 0 1 2])).gates.length = 0

-- cascade_nested_h
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0])).gates.length = 0

-- cascade_six_h
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0])).gates.length = 0

-- cascade_odd_count_leaves_one
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0, Gate.h 0])).gates.length = 1

-- cascade_nested_cnot
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.cnot 0 1, Gate.cnot 0 1, Gate.cnot 0 1])).gates.length = 0

-- cascade_mixed_self_inverse
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.x 0, Gate.h 0, Gate.x 0])).gates.length = 2

-- cascade_different_qubits_interleaved
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.h 1, Gate.h 1, Gate.h 0])).gates.length = 0

-- cascade_deep_nesting
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.x 0, Gate.z 0, Gate.z 0, Gate.x 0, Gate.h 0])).gates.length = 0

-- cascade_deep_nesting_with_residual
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.x 0, Gate.x 0, Gate.h 0, Gate.t 0])).gates.length = 2
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.x 0, Gate.x 0, Gate.h 0, Gate.t 0])).gates[0]? = some (Gate.t 0)
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.x 0, Gate.x 0, Gate.h 0, Gate.t 0])).gates[1]? = some (Gate.t 0)

-- cascade_cnot_nested_in_h
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.cnot 0 1, Gate.cnot 0 1, Gate.h 0])).gates.length = 0

-- commute_h_past_many_unrelated
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 0, Gate.t 1, Gate.s 2, Gate.tdg 3, Gate.h 0])).gates.length = 3

-- commute_cnot_past_unrelated_qubits
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.cnot 0 1, Gate.h 2, Gate.t 3, Gate.cnot 0 1])).gates.length = 2

-- commute_ccx_past_unrelated_qubits
#guard (runCancel (RawCircuit.ofGates 5 0 [Gate.ccx 0 1 2, Gate.h 3, Gate.t 4, Gate.ccx 0 1 2])).gates.length = 2

-- t_t_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.t 0])).gates.length = 2

-- tdg_tdg_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.tdg 0, Gate.tdg 0])).gates.length = 2

-- s_s_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.s 0, Gate.s 0])).gates.length = 2

-- sdg_sdg_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.sdg 0, Gate.sdg 0])).gates.length = 2

-- t_tdg_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.tdg 0])).gates.length = 2

-- s_sdg_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.s 0, Gate.sdg 0])).gates.length = 2

-- rz_rz_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.rz (1/4) 0, Gate.rz (1/4) 0])).gates.length = 2

-- independent_cancellations_on_many_qubits
#guard (runCancel (RawCircuit.ofGates 5 0 [Gate.h 0, Gate.h 1, Gate.h 2, Gate.h 3, Gate.h 4, Gate.h 4, Gate.h 3, Gate.h 2, Gate.h 1, Gate.h 0])).gates.length = 0

-- partial_cancellation_mixed_qubits
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.h 0, Gate.h 1, Gate.x 2, Gate.t 1, Gate.h 0, Gate.h 1, Gate.x 2])).gates.length = 3

-- interleaved_cancel_different_gate_types
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.x 1, Gate.h 0, Gate.x 1])).gates.length = 0

-- cnot_blocks_h_on_shared_qubit
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.cnot 0 1, Gate.h 0])).gates.length = 3

-- h_not_blocked_by_cnot_on_other_qubits
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.h 0, Gate.cnot 1 2, Gate.h 0])).gates.length = 1

-- surviving_gates_preserve_order
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.t 0, Gate.h 1, Gate.h 1, Gate.s 0, Gate.x 2, Gate.x 2, Gate.tdg 0])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.t 0, Gate.h 1, Gate.h 1, Gate.s 0, Gate.x 2, Gate.x 2, Gate.tdg 0])).gates[0]? = some (Gate.t 0)
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.t 0, Gate.h 1, Gate.h 1, Gate.s 0, Gate.x 2, Gate.x 2, Gate.tdg 0])).gates[1]? = some (Gate.s 0)
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.t 0, Gate.h 1, Gate.h 1, Gate.s 0, Gate.x 2, Gate.x 2, Gate.tdg 0])).gates[2]? = some (Gate.tdg 0)

-- order_after_cascade
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.h 0, Gate.s 0])).gates.length = 2
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.h 0, Gate.s 0])).gates[0]? = some (Gate.t 0)
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.h 0, Gate.s 0])).gates[1]? = some (Gate.s 0)

-- alternating_cancel_no_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.t 0, Gate.h 0, Gate.h 0, Gate.t 0])).gates.length = 2
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.t 0, Gate.h 0, Gate.h 0, Gate.t 0])).gates[0]? = some (Gate.t 0)
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0, Gate.t 0, Gate.h 0, Gate.h 0, Gate.t 0])).gates[1]? = some (Gate.t 0)

-- deeply_nested_cascade_8_layers
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.x 0, Gate.z 0, Gate.h 0, Gate.h 0, Gate.z 0, Gate.x 0, Gate.h 0])).gates.length = 0

-- has_toffoli_set_when_ccx_survives
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 3, Gate.h 3, Gate.ccx 0 1 2])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 3, Gate.h 3, Gate.ccx 0 1 2])).hasToffoli = true

-- has_toffoli_cleared_when_ccx_cancelled
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccx 0 1 2, Gate.ccx 0 1 2])).gates.length = 0
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccx 0 1 2, Gate.ccx 0 1 2])).hasToffoli = false

-- cnot_and_ccx_block_each_other_on_shared_qubit
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.cnot 0 1, Gate.ccx 1 2 3, Gate.cnot 0 1])).gates.length = 3

-- cnot_and_ccx_no_shared_qubit
#guard (runCancel (RawCircuit.ofGates 5 0 [Gate.cnot 0 1, Gate.ccx 2 3 4, Gate.cnot 0 1])).gates.length = 1

-- multiple_cnot_pairs_different_qubit_pairs
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.cnot 0 1, Gate.cnot 2 3, Gate.cnot 2 3, Gate.cnot 0 1])).gates.length = 0

-- single_gate_each_type_preserved
#guard (runCancel (RawCircuit.ofGates 5 0 [Gate.h 0, Gate.x 1, Gate.z 2, Gate.cnot 3 4])).gates.length = 4

-- blocker_is_latest_not_earliest
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.x 0, Gate.h 0])).gates.length = 4

-- blocker_matches_when_latest_is_same
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.h 0, Gate.h 0])).gates.length = 2
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.h 0, Gate.h 0])).gates[0]? = some (Gate.h 0)
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.h 0, Gate.h 0])).gates[1]? = some (Gate.t 0)

-- cascade_partial_then_full
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.t 1, Gate.h 0, Gate.x 1, Gate.h 0, Gate.x 1, Gate.t 1])).gates.length = 2
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.t 1, Gate.h 0, Gate.x 1, Gate.h 0, Gate.x 1, Gate.t 1])).gates[0]? = some (Gate.t 1)
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.t 1, Gate.h 0, Gate.x 1, Gate.h 0, Gate.x 1, Gate.t 1])).gates[1]? = some (Gate.t 1)

-- hh_blocked_by_reset_on_same_qubit
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.reset 0, Gate.h 0])).gates.length = 3

-- hh_allowed_past_reset_on_other_qubit
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.reset 1, Gate.h 0])).gates.length = 1
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.reset 1, Gate.h 0])).gates[0]? = some (Gate.reset 1)

-- cnot_blocked_by_reset_on_target
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cnot 0 1, Gate.reset 1, Gate.cnot 0 1])).gates.length = 3

-- measure_reset_pair_does_not_cancel
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.reset 0, Gate.reset 0])).gates.length = 2

-- hxh_becomes_z
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.x 0, Gate.h 0])).gates.length = 1

-- hzh_becomes_x
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.z 0, Gate.h 0])).gates.length = 1

-- hadamard_run_summing_to_identity_collapses
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.sdg 0, Gate.s 0, Gate.h 0])).gates.length = 0

-- cnot_inside_hadamards_blocks_reduction
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.cnot 0 1, Gate.h 0])).gates.length = 3

-- lone_hadamard_is_kept
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.h 0, Gate.t 0])).gates.length = 3

-- reduction_exposes_pair_cancellation
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.z 0, Gate.h 0, Gate.x 0, Gate.h 0])).gates.length = 0

-- cz_pair_cancels_through_diagonals_on_both_operands
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cz 0 1, Gate.t 0, Gate.sdg 1, Gate.rz (0.31) 0, Gate.z 1, Gate.cz 1 0])).gates.length = 4

-- reset_on_operand_blocks_cz_cancellation
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cz 0 1, Gate.reset 1, Gate.cz 0 1])).gates.length = 3

-- cnot_pair_blocked_by_cz_on_target
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cnot 2 1, Gate.cz 0 1, Gate.cnot 2 1])).gates.length = 3
...
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccz 0 1 2, Gate.h 0, Gate.ccz 2 0 1])).hasCcz = true
#guard (runCancel (RawCircuit.ofGates 3 0
  [Gate.ccz 0 1 2, Gate.h 1, Gate.ccz 2 0 1])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccz 0 1 2, Gate.h 1, Gate.ccz 2 0 1])).hasCcz = true
#guard (runCancel (RawCircuit.ofGates 3 0
  [Gate.ccz 0 1 2, Gate.h 2, Gate.ccz 2 0 1])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.ccz 0 1 2, Gate.h 2, Gate.ccz 2 0 1])).hasCcz = true

-- ccz_cancels_across_disjoint_gate
#guard (runCancel (RawCircuit.ofGates 4 0
  [Gate.ccz 0 1 2, Gate.t 3, Gate.ccz 2 1 0])).gates = [Gate.t 3]
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.ccz 0 1 2, Gate.t 3, Gate.ccz 2 1 0])).hasCcz = false
...
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 0, Gate.ccx 0 1 2, Gate.h 0])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 1, Gate.ccx 0 1 2, Gate.h 1])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 2, Gate.ccx 0 1 2, Gate.h 2])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 4 0 [Gate.h 3, Gate.ccx 0 1 2, Gate.h 3])).gates.length = 1

-- many_pairs_single_qubit
#guard (runCancel (RawCircuit.ofGates 1 0 (List.replicate 200 (Gate.h 0)))).gates.length = 0

-- many_pairs_odd_leaves_one
#guard (runCancel (RawCircuit.ofGates 1 0 (List.replicate 201 (Gate.h 0)))).gates.length = 1

-- hh_blocked_by_measure_on_same_qubit
#guard (runCancel (RawCircuit.ofGates 1 1
  [Gate.h 0, Gate.measure 0 0, Gate.h 0])).gates.length = 3
#guard (runCancel (RawCircuit.ofGates 1 1
  [Gate.h 0, Gate.measure 0 0, Gate.h 0])).hasMeasurement = true
#guard (runCancel (RawCircuit.ofGates 1 1 [Gate.h 0, Gate.measure 0 0, Gate.h 0])).numCbits = 1

-- hh_blocked_by_reset_on_same_qubit
#guard (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.reset 0, Gate.h 0])).gates.length = 3

-- hh_allowed_past_measure_on_other_qubit
#guard (runCancel (RawCircuit.ofGates 2 1
  [Gate.h 0, Gate.measure 1 0, Gate.h 0])).gates = [Gate.measure 1 0]

-- hh_allowed_past_reset_on_other_qubit
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.reset 1, Gate.h 0])).gates = [Gate.reset 1]
...
#guard (runCancel (RawCircuit.ofGates 3 1
  [Gate.cnot 0 1, Gate.measure 2 0, Gate.cnot 0 1])).gates = [Gate.measure 2 0]

-- cnot_blocked_by_reset_on_target
#guard (runCancel (RawCircuit.ofGates 2 0
...
-- num_cbits_preserved
#guard (runCancel (RawCircuit.ofGates 1 3 [Gate.h 0, Gate.h 0])).gates.length = 0
#guard (runCancel (RawCircuit.ofGates 1 3 [Gate.h 0, Gate.h 0])).numCbits = 3

-- cascade_depth_10
#guard (runCancel (RawCircuit.ofGates 1 0
...
#guard countH (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.s 0, Gate.h 0])) = 1

-- hsh_cascade_eliminates_all_hadamards
#guard countH (runCancel (RawCircuit.ofGates 1 0
  [Gate.h 0, Gate.s 0, Gate.h 0, Gate.s 0, Gate.h 0])) = 0

-- hxh_reduced_despite_other_qubit_gate_between
#guard countH (runCancel (RawCircuit.ofGates 3 0
  [Gate.h 0, Gate.x 0, Gate.cnot 1 2, Gate.h 0])) = 0

-- hadamard_run_with_t_is_not_reducible
#guard countH (runCancel (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.h 0])) = 2
...
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cz 0 1, Gate.cz 0 1])).gates = []

-- reversed_operand_cz_pair_cancels
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cz 0 2, Gate.cz 2 0])).gates = []

-- cz_pair_lookahead_commutation_table
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 3 0
  [Gate.cz 0 1, Gate.cz 1 2, Gate.cz 1 0])) = 1
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cz 0 1, Gate.cz 1 2, Gate.cz 1 0])).gates.length = 1
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 3 0
  [Gate.cz 0 1, Gate.cnot 0 2, Gate.cz 1 0])) = 0
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cz 0 1, Gate.cnot 0 2, Gate.cz 1 0])).gates.length = 1
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 3 0
  [Gate.cz 0 1, Gate.cnot 2 1, Gate.cz 1 0])) = 2
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cz 0 1, Gate.cnot 2 1, Gate.cz 1 0])).gates.length = 3
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 4 0
...
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 2 0
  [Gate.cz 0 1, Gate.x 0, Gate.cz 1 0])) = 2
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cz 0 1, Gate.x 0, Gate.cz 1 0])).gates.length = 3
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 2 0
  [Gate.cz 0 1, Gate.h 1, Gate.cz 1 0])) = 2
#guard (runCancel (RawCircuit.ofGates 2 0 [Gate.cz 0 1, Gate.h 1, Gate.cz 1 0])).gates.length = 3
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 3 0
  [Gate.cz 0 1, Gate.x 2, Gate.cz 1 0])) = 0
#guard (runCancel (RawCircuit.ofGates 3 0 [Gate.cz 0 1, Gate.x 2, Gate.cz 1 0])).gates.length = 1
...
#guard countKind isCzGate (runCancel (RawCircuit.ofGates 5 0
...
#guard (runCancel (runCancel (RawCircuit.ofGates 4 0
...
-- bell_pair
#guard (RawCircuit.ofGates 2 0 [Gate.h 0, Gate.cnot 0 1]).gates.length = 2
#guard ((RawCircuit.ofGates 2 0 [Gate.h 0, Gate.cnot 0 1]).toString.splitOn "h q0").length = 2
#guard ((RawCircuit.ofGates 2 0 [Gate.h 0, Gate.cnot 0 1]).toString.splitOn "cnot q0, q1").length = 2

-- ghz_state
#guard (RawCircuit.ofGates 4 0
  [Gate.h 0, Gate.cnot 0 1, Gate.cnot 1 2, Gate.cnot 2 3]).gates.length = 4

-- t_gate_decomposition_of_rz
#guard (RawCircuit.ofGates 1 0 [Gate.t 0, Gate.s 0, Gate.rz (1/4) 0]).gates.length = 3

-- ccx_gate
#guard (RawCircuit.ofGates 3 0 [Gate.h 2, Gate.ccx 0 1 2, Gate.h 2]).gates.length = 3
#guard (RawCircuit.ofGates 3 0 [Gate.h 2, Gate.ccx 0 1 2, Gate.h 2]).hasToffoli = true

-- ccz_gate_display_and_metadata
#guard ((RawCircuit.ofGates 3 0 [Gate.ccz 2 0 1]).toString.splitOn "ccz q2, q0, q1").length = 2
#guard (RawCircuit.ofGates 3 0 [Gate.ccz 2 0 1]).hasToffoli = false
#guard (RawCircuit.ofGates 3 0 [Gate.ccz 2 0 1]).hasCcz = true
...
-- z_gate_display
-- sdg_gate_display
#guard ((RawCircuit.ofGates 1 0 [Gate.z 0]).toString.splitOn "z q0").length = 2
#guard ((RawCircuit.ofGates 1 0 [Gate.sdg 0]).toString.splitOn "sdg q0").length = 2

-- cz_gate_display_and_metadata
#guard ((RawCircuit.ofGates 3 0 [Gate.cz 2 0]).toString.splitOn "cz q2, q0").length = 2
#guard (RawCircuit.ofGates 3 0 [Gate.cz 2 0]).hasToffoli = false
#guard (RawCircuit.ofGates 3 0 [Gate.cz 2 0]).hasMeasurement = false
...
#guard ((RawCircuit.ofGates 1 1 [Gate.measure 0 0]).toString.splitOn "measure q0 -> c0").length = 2
#guard (RawCircuit.ofGates 1 1 [Gate.measure 0 0]).hasMeasurement = true

-- reset_gate_display
#guard ((RawCircuit.ofGates 1 0 [Gate.reset 0]).toString.splitOn "reset q0").length = 2
#guard (RawCircuit.ofGates 1 0 [Gate.reset 0]).hasMeasurement = true
...
#guard (RawCircuit.withCbits 2 3).numQubits = 2
#guard (RawCircuit.withCbits 2 3).numCbits = 3
#guard (RawCircuit.withCbits 2 3).hasMeasurement = false
#guard (RawCircuit.withCbits 2 3).hasToffoli = false
#guard (RawCircuit.withCbits 2 3).hasCcz = false
#guard (RawCircuit.withCbits 2 3).gates.length = 0

-- has_measurement_flag_set_by_reset_alone
#guard (RawCircuit.new 1).hasMeasurement = false
#guard ((RawCircuit.new 1).apply (Gate.reset 0)).hasMeasurement = true

/-! ## `src/pass.rs` -/

-- count_2q_counts_cnot_and_cz_only
#guard count2q (RawCircuit.ofGates 3 0 [Gate.h 0, Gate.cnot 0 1, Gate.cz 1 2, Gate.t 0]) = 2

-- count_rz_counts_only_rz_gates
#guard countRz (RawCircuit.ofGates 1 0 [Gate.rz (1/4) 0, Gate.t 0, Gate.rz (-1/2) 0]) = 2

-- depth_layers_disjoint_gates_and_serializes_shared_qubits
#guard depth (RawCircuit.ofGates 3 0 [Gate.h 0, Gate.h 1, Gate.cnot 0 2, Gate.t 1]) = 2

-- depth_of_empty_circuit_is_zero
#guard depth (RawCircuit.new 4) = 0

-- depth_serializes_gates_on_one_qubit
#guard depth (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.t 0, Gate.z 0]) = 3

-- depth_propagates_through_multi_qubit_dependencies
#guard depth (RawCircuit.ofGates 3 0 [Gate.cnot 0 1, Gate.x 1, Gate.cz 1 2]) = 3

/-! ## The pass API itself -/

-- Composition of two passes is again a pass, correctness included.
#guard ((Pass.comp CancelGates CancelGates).run
  (Circuit.of (RawCircuit.ofGates 1 0 [Gate.h 0, Gate.h 0]) (by decide))).raw.gates.length = 0
#guard (Pass.runAll [CancelGates, CancelGates]
  (Circuit.of (RawCircuit.ofGates 2 0
...
/-- The pass under test, as a plain function. -/
def runCnotMin (c : RawCircuit) : RawCircuit := cnotMinCircuit c
...
#guard (runCnotMin (RawCircuit.ofGates 3 0
...
#guard countKind (fun g => match g with | .ccz .. | .ccx .. => true | _ => false)
  (runCnotMin (RawCircuit.ofGates 3 0
...
#guard (runCnotMin (RawCircuit.ofGates 2 1
...
#guard ((List.range 7).all fun k =>
  (runCnotMin (RawCircuit.ofGates 2 0
...
#guard (runCnotMin (RawCircuit.ofGates 1 0 (List.replicate 8 (Gate.t 0)))).gates.length = 0

-- empty_and_single_gate_circuits_round_trip
#guard (runCnotMin (RawCircuit.new 3)).gates.length = 0
#guard (runCnotMin (RawCircuit.ofGates 2 0 [Gate.h 1])).gates = [Gate.h 1]
...
#guard (runCnotMin (RawCircuit.ofGates 2 0 (List.replicate 3 (Gate.cnot 0 0)))).gates
  = List.replicate 3 (Gate.cnot 0 0)

-- qubits_outside_a_block_are_untouched
#guard (runCnotMin (RawCircuit.ofGates 40 0
...
#guard (runCnotMin (RawCircuit.ofGates 3 0 [Gate.cnot 0 1, Gate.t 1, Gate.h 0, Gate.cnot 1 2])).gates
  = (runCnotMin (RawCircuit.ofGates 3 0
...
def settles : Nat → RawCircuit → Bool
  | 0, _ => false
  | k + 1, c =>
...
def sweepCase (s : UInt64) : Bool × UInt64 :=
  ...
  let c := RawCircuit.ofGates n 0 gs
...
def runCnotMinAt (maxQ maxT : Nat) (c : RawCircuit) : RawCircuit :=
  c.withGates (cnotMinGates c.numQubits maxQ maxT c.gates)

def settlesAt (maxQ maxT : Nat) : Nat → RawCircuit → Bool
  | 0, _ => false
  | k + 1, c =>
